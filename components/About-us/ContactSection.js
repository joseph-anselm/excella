  ...
  return (
    <div className="container mx-auto py-16 px-4 md:px-8 lg:px-16 xl:px-32">
      ...
      >
        ...
        {/* Container */}
        <div className="flex flex-col md:flex-row items-center text-white relative z-10">
          {/* Left Column (2/3 width) */}
          <div className="md:w-2/3 mx-auto md:mx-0 text-center md:text-left mb-8 md:mb-0">
